        ...
        <SafeAreaView accessibilityViewIsModal style={styles.root} edges={['top', 'bottom']}>
          ...
          <View style={styles.tagModalBody}>
            ...
            {tagFrame && (
              <View
                ref={frameRef}
                style={{ width: '100%', aspectRatio: tagFrame.width / tagFrame.height, borderRadius: 4, overflow: 'hidden' }}
              >
                <Pressable
...
function makeStyles(colors: ReturnType<typeof useThemeColors>) {
  ...
  toggleRow: { flexDirection: 'row', backgroundColor: '#e7e7ea', borderRadius: 4, padding: 3, marginBottom: 16 },
  toggleBtn: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingVertical: 11, borderRadius: 4 },
  toggleBtnActive: { backgroundColor: colors.primaryDark, shadowColor: '#000', shadowOpacity: 0.08, shadowRadius: 4, shadowOffset: { width: 0, height: 1 } },
  toggleText: { fontFamily: fontFamily.medium, fontSize: fontSize.bodySm, color: colors.textMuted },
  toggleTextActive: { fontFamily: fontFamily.semiBold, color: colors.gold },
  dropZone: {
    borderRadius: 4,
    borderWidth: 2,
  ...
  dropIconWrap: { width: 56, height: 56, borderRadius: 4, backgroundColor: colors.infoTint, alignItems: 'center', justifyContent: 'center', marginBottom: 6 },
  ...
  videoRemoveBtn: { position: 'absolute', top: 10, right: 10, width: 28, height: 28, borderRadius: 4, backgroundColor: 'rgba(0,0,0,0.5)', alignItems: 'center', justifyContent: 'center' },
  tagRow: { flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: colors.surfaceMuted, borderRadius: 4, padding: 12, marginBottom: 20 },
  tagIconWrap: { width: 32, height: 32, borderRadius: 4, backgroundColor: colors.surface, alignItems: 'center', justifyContent: 'center' },
  ...
  aiHint: { flexDirection: 'row', gap: 10, backgroundColor: colors.infoTint, borderRadius: 4, padding: spacing.lg, marginBottom: 20, alignItems: 'flex-start' },
  aiHintIconWrap: { width: 26, height: 26, borderRadius: 4, backgroundColor: colors.surface, alignItems: 'center', justifyContent: 'center', marginTop: 1 },
