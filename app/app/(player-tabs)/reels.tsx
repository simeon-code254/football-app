...
function makeStyles(colors: ReturnType<typeof useThemeColors>) {
  ...
  creatorAvatar: { width: 32, height: 32, borderRadius: 4, borderWidth: 1.5, borderColor: colors.white },
  ...
  commentsSheet: { backgroundColor: colors.surface, borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 20, paddingBottom: 24 },
  ...
  commentAvatarFallback: { width: 32, height: 32, borderRadius: 4, backgroundColor: colors.surfaceMuted },
  ...
  commentInput: { flex: 1, backgroundColor: colors.surfaceMuted, borderRadius: 4, paddingHorizontal: 14, paddingVertical: 10, fontFamily: fontFamily.regular, fontSize: fontSize.bodySm, color: colors.textPrimary },
  commentSendBtn: { width: 40, height: 40, borderRadius: 4, backgroundColor: colors.primary, alignItems: 'center', justifyContent: 'center' },
  });
}
