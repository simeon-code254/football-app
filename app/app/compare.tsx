...
function makeStyles(colors: ReturnType<typeof useThemeColors>) {
  ...
  row: { flexDirection: 'row', alignItems: 'center', paddingVertical: 10, borderRadius: 4 },
  rowAlt: { backgroundColor: colors.surfaceMuted },
  rowHighlight: { backgroundColor: colors.primaryDark },
  ...
  avatar: { width: 44, height: 44, borderRadius: 4, marginBottom: 6 },
