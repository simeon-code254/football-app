...
function makeStyles(colors: ReturnType<typeof useThemeColors>) {
  ...
  convoRowUnread: { borderWidth: 1, borderColor: colors.gold },
  safety: { marginHorizontal: 20, marginBottom: 12, borderRadius: 4 },
  safetyStrong: { fontFamily: fontFamily.bold },
  convoLastUnread: { fontFamily: fontFamily.semiBold, color: colors.textPrimary },
  convoAvatar: { width: 46, height: 46, borderRadius: 4 },
  ...
  unreadDot: { backgroundColor: colors.primary, borderRadius: 4, minWidth: 18, height: 18, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 4 },
  ...
  threadAvatar: { width: 38, height: 38, borderRadius: 4 },
  ...
  contextBubble: { backgroundColor: colors.surfaceMuted, borderRadius: 4, padding: 12, alignSelf: 'flex-start', maxWidth: '90%' },
  ...
  bubbleMine: { backgroundColor: colors.primary, alignSelf: 'flex-end', borderTopLeftRadius: 4, borderTopRightRadius: 14, borderBottomRightRadius: 4, borderBottomLeftRadius: 14 },
  bubbleTheirs: { backgroundColor: colors.surface, alignSelf: 'flex-start', borderTopLeftRadius: 4, borderTopRightRadius: 14, borderBottomRightRadius: 14, borderBottomLeftRadius: 4 },
  ...
  attachBtn: { width: 38, height: 38, borderRadius: 4, backgroundColor: colors.surfaceMuted, alignItems: 'center', justifyContent: 'center' },
  charCount: {
  ...
  composeInput: { maxHeight: 100, backgroundColor: colors.surfaceMuted, borderRadius: 4, paddingHorizontal: 14, paddingVertical: 10, fontFamily: fontFamily.regular, fontSize: fontSize.bodySm, color: colors.textPrimary },
  sendBtn: { width: 36, height: 36, borderRadius: 9999, backgroundColor: colors.primary, alignItems: 'center', justifyContent: 'center' },
  ...
  attachmentImage: { width: 180, height: 130, borderRadius: 4, marginBottom: 6 },
